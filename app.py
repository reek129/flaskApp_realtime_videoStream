...
def get_labels():
    ...
    return jsonify({
        'classical_class_label': f"Class {classical_class_label}",
        'classical_attacked_class_label': f"Class {classical_attacked_class_label}",
        'quantum_class_label': f"Class {quantum_class_label}",
        'quantum_attacked_class_label': f"Class {quantum_attacked_class_label}",
